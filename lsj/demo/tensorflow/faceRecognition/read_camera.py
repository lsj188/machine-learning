...
import cv2
from lsj.demo.tensorflow.faceRecognition.train_model import Model
from lsj.demo.tensorflow.faceRecognition.read_data import read_name_list
...
class Camera_reader(object):
    ...
    def build_camera(self):
        ...
        face_cascade = cv2.CascadeClassifier('D:\ProgramData\opencv\sources\data\haarcascades\haarcascade_frontalface_alt.xml')
